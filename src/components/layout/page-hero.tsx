...
export function PageHero({
  ...
  return (
    <section
      data-hero
      className={cn("relative overflow-hidden border-b border-sand/80", className)}
    >
      <div className="relative min-h-[32vh] overflow-hidden md:min-h-[38vh]">
        ...
        <div
          data-hero-copy
          className="relative z-10 mx-auto flex min-h-[32vh] max-w-4xl flex-col items-center justify-center px-4 py-16 text-center text-cream md:min-h-[38vh] md:px-6"
        >
          {eyebrow ? (
