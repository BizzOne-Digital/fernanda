    ...
    <>
      ...
      <section className="resort-band">
        <div className="mx-auto grid max-w-7xl divide-y divide-sand/80 md:grid-cols-3 md:divide-x md:divide-y-0">
          {QUICK_LINKS.map((item) => (
            <Link key={item.href} href={item.href} className="group block p-6 md:p-8 hover:bg-sand/20">
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 md:px-6">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {(testimonials.length > 0 ? testimonials.slice(0, 6) : []).map((item) => (
            <blockquote key={item._id} className="resort-card p-6">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {activityPreview.map((item) => (
              <Link
                ...
                className="resort-card p-5 hover:border-lake-medium/40"
              >
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 md:px-6">
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="resort-card p-8 bg-resort-navy text-cream">
